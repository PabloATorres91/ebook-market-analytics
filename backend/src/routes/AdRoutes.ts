...
export async function adRoutes(fastify: FastifyInstance) {
  ...
  fastify.get('/api/ads/:id', async (request, reply) => {
    try {
      ...
      const niches = nicheDetector.detectNiche(ad.body);
